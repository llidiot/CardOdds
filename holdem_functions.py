...
def generate_random_boards(deck, num_iterations, board_length, unassigned_num_players):
    import random
    import time
    random.seed(time.time())
    for iteration in xrange(num_iterations):
        yield random.sample(deck, 5 - board_length + unassigned_num_players * 2)

# Generate all possible boards
#def generate_exhaustive_boards(deck, num_iterations, board_length, unassigned_num_players):
#    import itertools
#    return itertools.combinations(deck, 5 - board_length + unassigned_num_players * 2)
